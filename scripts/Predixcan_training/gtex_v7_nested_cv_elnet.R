...
main <- function(snp_annot_file, gene_annot_file, genotype_file, expression_file,
  ...
  # Prepare output data----
  model_summary_file <- 'C:/Users/AKIM0004/Documents/Predixcan/output/summary/' %&% prefix %&% '_chr' %&% chrom %&% '_model_summaries.txt'
  ...
  weights_file <- 'C:/Users/AKIM0004/Documents/Predixcan/output/weights/' %&% prefix %&% '_chr' %&% chrom %&% '_weights.txt'
  weights_col <- c('gene_id', 'rsid', 'varID', 'ref', 'alt', 'beta')
  write(weights_col, file = weights_file, ncol = 6, sep = '\t')
  
  tiss_chr_summ_f <- 'C:/Users/AKIM0004/Documents/Predixcan/output/summary/' %&% prefix %&% '_chr' %&% chrom %&% '_summary.txt'
  ...
  covariance_file <- 'C:/Users/AKIM0004/Documents/Predixcan/output/covariances/' %&% prefix %&% '_chr' %&% chrom %&% '_covariances.txt'
